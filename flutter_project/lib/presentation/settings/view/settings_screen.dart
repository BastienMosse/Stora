...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  String _getThemeName(ThemeType type) {
    switch (type) {
      case ThemeType.light:
        return locale.settings_light_theme;
      case ThemeType.dark:
        return locale.settings_dark_theme;
      case ThemeType.custom:
        return locale.settings_custom_theme;
    }
  }
  ...
  Widget _buildColorPalette(
    ...
    return Column(
      ...
      children: [
        Text(
          locale.settings_select_custom_color,
          style: TextStyle(color: theme.currentTheme.PrimaryText),
        ),
